...
import { MapPin, Clock, DollarSign, Heart, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-md card-hover border border-gray-100">
      ...
      <div className="relative h-56 overflow-hidden group">
        <Image
          src={getImageUrl(trip.cover_image) || 'https://images.unsplash.com/photo-1586096538339-0a0df57d50dd?w=600&q=80'}
          alt={trip.title}
          fill
      ...
      {/* Body */}
      <div className="p-5">
        <h3 className="font-heading font-bold text-lg text-gray-900 mb-1 line-clamp-2">{trip.title}</h3>
        <p className="text-gray-500 text-sm leading-relaxed mb-3">
          {truncateText(trip.short_description || '', 90)}
        </p>
